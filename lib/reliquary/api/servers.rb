...
module Reliquary
  module API
    class Servers < Reliquary::API::Base

      # URI fragment for Applications API endpoint
      URI_FRAGMENT = 'servers.json'
      ...
      def show(params = {})
        begin
          ...
          api_params = { :uri_fragment => "servers/#{id}.json" }
      ...
      def metric_names(params = {})
        begin
          ...
          # HTTP method is the default GET
          # override the URI fragment
          api_params = { :uri_fragment => "servers/#{id}/metrics.json" }
      ...
      def metric_data(params = {})
        begin
          ...
          # HTTP method is the default GET
          # override the URI fragment
          api_params = { :uri_fragment => "servers/#{id}/metrics/data.json" }
